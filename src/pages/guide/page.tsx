...
const GUIDE: GuideBlock[] = [
  {
    ...
    sections: [
      ...
      {
        sub: "三个大区",
        body: "左侧导航分为三大块：决策（Dashboard、发货决策、风险中心）帮你发现问题并做决策；运营（运营中心、SKU 详情、旺季模拟、促销管理、利润测算）帮你深度分析单品和规划新品；数据（数据导入、参数中心、使用指南）是数据入口和配置后台。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      {
        sub: "SKU 列表页",
        body: "展示所有 SKU 的一行摘要：品名、店铺、生命周期、总库存、全部月销总和、近七天日均总销量、评分。支持按店铺、状态筛选和关键词搜索。点击任意行进入详情。",
      },
      {
        sub: "头部信息条",
